...
### Added
- **Background meeting sync** - Meetings now sync automatically from Granola every 30 minutes via macOS Launch Agent. No more terminal commands during `/process-meetings`. Setup: `cd .scripts/meeting-intel && ./install-automation.sh`
